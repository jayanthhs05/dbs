...
class Leaderboard(models.Model):
    contest = models.OneToOneField(Contest, on_delete=models.CASCADE, related_name='leaderboard')
...
class Comment(models.Model):
    ...
    # Optional foreign keys for different comment targets
    problem = models.ForeignKey(Problem, on_delete=models.CASCADE, related_name='comments', null=True, blank=True)
    submission = models.ForeignKey(Submission, on_delete=models.CASCADE, related_name='comments', null=True, blank=True)
    contest = models.ForeignKey(Contest, on_delete=models.CASCADE, related_name='comments', null=True, blank=True)
